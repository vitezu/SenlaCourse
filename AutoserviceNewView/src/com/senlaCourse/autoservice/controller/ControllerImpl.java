...
import workingOfAnnotation.ConfigProperty;
import workingOfAnnotation.Inject;
...
public class ControllerImpl implements IController {
    ...
    @ConfigProperty(configName = "config.property", propertyName = "permitDelOrder", type = Boolean.class)
    @Override
    ...
    @Override
    @ConfigProperty(configName = "config.property", propertyName = "enableShiftTime", type = Boolean.class)
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("ControllerImpl{");
